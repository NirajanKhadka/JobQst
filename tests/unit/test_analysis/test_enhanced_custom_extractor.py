...
class TestCustomExtractor:
    ...
    def test_malformed_data_handling(self, extractor):
        ...
        malformed_data = {"description": "This is not a proper job posting. Random text here."}
...
class TestExtractionReliability:
    ...
    def test_confidence_accuracy_correlation(self, extractor):
        ...
        low_quality_job = {"description": "Need someone for coding work. Good pay. Contact us."}
        ...
        assert (
            high_result.overall_confidence > 0.75
        )  # Adjusted threshold based on actual performance
        ...
        high_fields = sum(
            ...
            for field in [
                high_result.title,
                high_result.company,
                high_result.location,
                high_result.salary_range,
            ]
