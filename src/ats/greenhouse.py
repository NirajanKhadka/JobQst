...
class GreenhouseSubmitter(BaseSubmitter):
    ...
    def submit(self, job: Dict, profile: Dict, resume_path: str, cover_letter_path: str) -> str:
        ...
        try:
            ...
            for selector in email_selectors:
                if FormUtils.fill_if_empty(page, selector, profile.get("email", "")):
                    break
            ...
            for selector in phone_selectors:
                if FormUtils.fill_if_empty(page, selector, profile.get("phone", "")):
                    break
    ...
    def _fill_name_fields(self, page: Page, profile: Dict) -> bool:
        ...
        for selector in first_name_selectors:
            if FormUtils.fill_if_empty(page, selector, first_name):
                first_filled = True
                break
        ...
        for selector in last_name_selectors:
            if FormUtils.fill_if_empty(page, selector, last_name):
                last_filled = True
                break
        ...
        if not (first_filled and last_filled):
            ...
            for selector in full_name_selectors:
                if FormUtils.fill_if_empty(page, selector, full_name):
                    return True
    ...
    def _fill_additional_fields(self, page: Page, profile: Dict) -> int:
        ...
        for selector in location_selectors:
            if FormUtils.fill_if_empty(page, selector, profile.get("location", "")):
                fields_filled += 1
                break
        ...
        for selector in linkedin_selectors:
            if FormUtils.fill_if_empty(page, selector, profile.get("linkedin", "")):
                fields_filled += 1
                break
        ...
        for selector in github_selectors:
            if FormUtils.fill_if_empty(page, selector, profile.get("github", "")):
                fields_filled += 1
                break
