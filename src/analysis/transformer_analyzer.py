...
class TransformerJobAnalyzer:
    ...
    def __init__(
        ...
        console.print(f"[cyan]🤖 Initializing Enhanced Transformer Analyzer on {self.device}[/cyan]")
        ...
        try:
            ...
            for entity in ner_results:
                if entity['entity_group'] in ['ORG', 'MISC'] and len(entity['word']) > 2:
                    ...
                    if any(tech_indicator in word.lower() for tech_indicator in 
            ...
            tech_skills = [
                ...
                'Kubernetes', 'React', 'Vue.js', 'Node.js', 'Django', 'Flask', 'Spring',
    ...
    def _calculate_semantic_compatibility(self, job_embeddings: np.ndarray) -> float:
        ...
        try:
            ...
            similarity = cosine_similarity(
                self.user_embeddings.reshape(1, -1),
...
def integrate_transformer_stage2(job_data: Dict[str, Any], user_profile: Dict[str, Any]) -> Dict[str, Any]:
    """
