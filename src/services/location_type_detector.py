...
class LocationTypeDetector:
    ...
    def detect_location_type(self, job_data: Dict[str, Any]) -> Dict[str, Any]:
        ...
        result = self._apply_additional_logic(
            job_data, location_type, confidence, 
            remote_score, hybrid_score, onsite_score
        )
        
        logger.debug(f"Location detection: {job_data.get('title', 'Unknown')} -> "
    ...
    def _apply_additional_logic(self, job_data: Dict[str, Any], 
                               location_type: str, confidence: float,
                               remote_score: float, hybrid_score: float, 
                               onsite_score: float) -> Dict[str, Any]:
        ...
        remote_benefits = ['home office allowance', 'internet allowance', 
                          'remote work stipend', 'equipment provided']
        ...
        remote_friendly_companies = [
            'automattic', 'gitlab', 'buffer', 'zapier', 'basecamp',
            'github', 'stackoverflow', 'toptal', 'remote.com'
        ]
