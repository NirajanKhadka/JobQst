...
class CLICommand:
    def __init__(self, name: str, command: str, description: str, category: str = "general", estimated_duration: int = 30):
        self.name = name
...
class CLIService:
    ...
    def create_custom_command(self, name: str, command: str, description: str, category: str = "custom") -> CLICommand:
