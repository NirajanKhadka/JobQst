...
async def storage_stage(storage_queue: asyncio.Queue, metrics, db, thread_pool):
    ...
    logger.info(f"[{stage_correlation_id}] STORAGE: Stage started with database={type(db).__name__}")
    ...
    while True:
        ...
        try:
            ...
            StructuredLogger.log_job_event(
                job_correlation_id, "storage", "job_received", job_data,
            ...
            try:
                ...
                StructuredLogger.log_job_event(
                    job_correlation_id, "storage", "database_save_started", job_data,
                ...
                if success:
                    ...
                    StructuredLogger.log_job_event(
                        job_correlation_id, "storage", "job_saved_successfully", job_data,
                        {
                    ...
                    StructuredLogger.log_job_event(
                        job_correlation_id, "storage", "job_duplicate_detected", job_data,
                        {
                            "storage_time_seconds": storage_time,
                ...
                StructuredLogger.log_job_event(
                    job_correlation_id, "storage", "database_save_failed", job_data,
                    {
                        "error": error_msg,
            ...
            if job_correlation_id and job_data:
                StructuredLogger.log_job_event(
                    job_correlation_id, "storage", "unexpected_error", job_data,
