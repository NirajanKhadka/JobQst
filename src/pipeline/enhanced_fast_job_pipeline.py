...
def get_Improved_fast_pipeline(profile_name: str = "Nirajan", **config) -> ImprovedFastJobPipeline:
    """Get configured Improved fast job pipeline instance."""
    return ImprovedFastJobPipeline(profile_name, config)
...
async def test_Improved_pipeline():
    ...
    pipeline = ImprovedFastJobPipeline("test_profile", {
        "enable_jobspy": True,
        "enable_eluta": False,
        "jobspy_preset": "fast",
