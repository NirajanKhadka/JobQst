...
def _add_scraping_arguments(parser: argparse.ArgumentParser) -> None:
    ...
    parser.add_argument("--sites", help="Comma-separated list of sites (eluta, indeed, linkedin)")
...
def _add_jobspy_arguments(parser: argparse.ArgumentParser) -> None:
    ...
    parser.add_argument(
        "--multi-site-workers", action="store_true", help="Use multi-site worker architecture"
    )
    parser.add_argument(
        "--hours-old",
        type=int,
