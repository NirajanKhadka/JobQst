...
class ResumeAnalyzer:
    ...
    def __init__(self, profile_name: str = "default"):
        ...
        self.technical_skills = {
            ...
            'programming': [
                ...
                'swift', 'kotlin', 'scala', 'r', 'matlab', 'sas', 'vba', 'html', 'css', 'sql'
            ],
            
            # Data & Analytics
            'data_analytics': [
                'pandas', 'numpy', 'scipy', 'matplotlib', 'seaborn', 'plotly', 'tableau', 'power bi',
                'excel', 'google analytics', 'statistical analysis', 'data visualization', 'data mining',
                'machine learning', 'deep learning', 'artificial intelligence', 'predictive modeling',
                'regression analysis', 'time series', 'a/b testing', 'hypothesis testing'
            ],
            
            # Databases
            'databases': [
                'mysql', 'postgresql', 'mongodb', 'redis', 'elasticsearch', 'oracle', 'sql server',
                'sqlite', 'cassandra', 'dynamodb', 'snowflake', 'bigquery'
            ],
            
            # Cloud & DevOps
            'cloud_devops': [
                'aws', 'azure', 'google cloud', 'gcp', 'docker', 'kubernetes', 'jenkins', 'git',
                'github', 'gitlab', 'terraform', 'ansible', 'linux', 'bash', 'powershell'
            ],
            
            # Web Development
            'web_development': [
                'react', 'angular', 'vue', 'node.js', 'express', 'django', 'flask', 'spring',
                'bootstrap', 'jquery', 'rest api', 'graphql', 'microservices'
            ],
            
            # Business & Soft Skills
            'business': [
                'project management', 'agile', 'scrum', 'business analysis', 'requirements gathering',
                'stakeholder management', 'process improvement', 'quality assurance', 'testing',
                'documentation', 'communication', 'leadership', 'teamwork'
            ]
        }
        ...
        self.experience_indicators = {
            'entry': [
                'junior', 'entry', 'associate', 'trainee', 'intern', 'graduate', 'assistant',
                'coordinator', 'analyst i', 'developer i', 'level 1', 'tier 1'
            ],
            'mid': [
                'analyst ii', 'developer ii', 'specialist', 'consultant', 'level 2', 'tier 2'
            ],
            'senior': [
                'senior', 'lead', 'principal', 'manager', 'director', 'head', 'chief',
                'architect', 'expert', 'level 3', 'tier 3'
            ]
        }
        
        # Industry-specific job titles
        self.job_titles = [
            'data analyst', 'business analyst', 'financial analyst', 'research analyst',
            ...
            'project manager', 'product manager', 'scrum master', 'business consultant',
            'quality assurance', 'qa engineer', 'test engineer', 'systems analyst'
        ]
    ...
    def generate_search_keywords(self, skills: Dict[str, List[str]], 
                                job_titles: List[str], 
    ...
    def analyze_resume(self, profile: Dict) -> Dict:
        ...
        resume_docx = profile_dir / profile.get('resume_docx', f"{profile['profile_name']}_Resume.docx")
    ...
    def _display_analysis_results(self, analysis: Dict):
        ...
        console.print(f"[bold]🎯 Experience Level:[/bold] [{exp_color}]{exp_level.upper()}[/{exp_color}]")
