...
class CookieSessionManager:
    ...
    def __init__(self, profile_name: Optional[str] = None, cookie_file: str = "", session_file: str = "", site_name: str = ""):
        """
        ...
        self.cookie_file = str(cookie_file) if cookie_file else f"profiles/{self.profile_name}/cookies/cookies.json"
        self.session_file = str(session_file) if session_file else f"profiles/{self.profile_name}/sessions/session.json"
