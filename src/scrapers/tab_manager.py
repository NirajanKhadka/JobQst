...
class TabManager:
    ...
    def click_and_get_popup_url(self, link: ElementHandle, page: Page, job_number: str = "") -> Optional[str]:
        """
        ...
        try:
            with page.expect_popup() as popup_info:
                ...
                console.print(f"[cyan]🖱️ Clicked job link (job {job_number}), waiting for popup...[/cyan]")
            ...
            console.print(f"[yellow]⚠️ Error during popup/tab handling for job {job_number}: {e}[/yellow]")
            return None 