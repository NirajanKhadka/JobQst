        ...
        [
            ...
            dbc.Card(
                [
                    ...
                    dbc.CardBody(
                        [html.Div(id="application-kanban-board", children=[create_kanban_board()])]
                    ),
                ]
            ),
        ]
...
def create_kanban_board():
    ...
    return dbc.Row(
        [dbc.Col([create_kanban_column(title, status, color) for title, status, color in statuses])]
    )
...
def create_kanban_column(title, status, color):
    ...
    return dbc.Col(
        [
            dbc.Card(
                [
                    dbc.CardHeader([html.H6(title, className=f"text-{color} mb-0")]),
                    dbc.CardBody(
                        [
                            html.Div(
                                id=f"kanban-{status}",
    ...
    return dbc.Modal(
        [
                            ...
                            dbc.Col(
                                [
                                    ...
                                    dcc.DatePickerSingle(
                                        id="app-date-picker", date=datetime.now().date()
                                    ),
                                    html.Label("Interview Date", className="fw-semibold mt-3"),
                                    dcc.DatePickerSingle(id="interview-date-picker"),
                                ],
                                width=6,
                            ),
                            dbc.Col(
            ...
            dbc.ModalFooter(
                [
                    dbc.Button(
                        "Cancel", id="app-modal-cancel", color="secondary", className="me-2"
                    ),
                    dbc.Button("Save Application", id="app-modal-save", color="primary"),
                ]
            ),
        ],
                                        ...
                                        [
                                            html.Div(
                                                [
                                                    ...
                                                    html.Br(),
                                                    html.Small(
                                                        "Tomorrow 2:00 PM", className="text-muted"
                                                    ),
                                                ]
                                            )
                                        ]
                                        ...
                                        [
                                            html.Div(
                                                [
                                                    ...
                                                    html.Br(),
                                                    html.Small(
                                                        "Friday 10:00 AM", className="text-muted"
                                                    ),
                                                ]
                                            )
                                        ]
                                ...
                                [
                                    ...
                                    dbc.Progress(
                                        [
                                            ...
                                            dbc.Progress(
                                                "Interviews: 3", value=3, color="success", bar=True
                                            ),
                                        ],
                                        multi=True,
                                    ),
