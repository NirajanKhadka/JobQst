...
def create_jobs_table(data=None):
    ...
    return dash_table.DataTable(
        ...
        css=[{
            ...
            'rule': ('background-color: #2d3436; color: white; '
                     'border: 1px solid #636e72;')
        }],
        tooltip_data=[
            {
                column: {'value': f'Click to edit {column}',
                         'type': 'markdown'}
...
def create_table_controls():
    ...
    return dbc.ButtonGroup([
        ...
        dbc.Button([
            ...
            "Export"
        ], id="export-jobs-btn", color="outline-secondary", size="sm"),
        
        dbc.Button([
            html.I(className="fas fa-trash me-1"),
            "Bulk Actions"
        ], id="bulk-actions-btn", color="outline-warning", size="sm")
    ], className="mb-3")
