...
def create_job_modal():
    ...
    return dbc.Modal([
        dbc.ModalHeader([
            dbc.ModalTitle("Job Details", id="job-modal-title")
        ]),
        dbc.ModalBody([
                ...
                dbc.Row([
                    dbc.Col([
                        ...
                        html.P([
                            ...
                            " • ",
                            html.Span(id="job-modal-location-header",
                                     className="text-muted")
                        ], className="mb-2"),
                        html.Div(id="job-modal-badges-container", className="mb-3")
                    ], width=8),
                    dbc.Col([
                        html.Div([
                            html.H5(id="job-modal-salary-display",
                                   className="text-success mb-2"),
                            html.P([
                                html.Strong("Match Score: "),
                                html.Span(id="job-modal-match-display",
                                         className="badge bg-primary")
                            ], className="mb-1"),
                            html.P([
                                html.Strong("Posted: "),
                                html.Span(id="job-modal-posted-display",
                                         className="text-muted")
                            ], className="mb-1")
                        ])
                    ], width=4)
            ...
            dbc.Row([
                ...
                dbc.Col([
                    ...
                    html.Div(id="job-modal-description",
                    ...
                    html.Div([
                        dbc.Row([
                            dbc.Col([
                                html.Strong("Company:"),
                                html.P(id="job-modal-company-details",
                                       className="text-muted mb-2")
                            ], width=6),
                            dbc.Col([
                                html.Strong("Industry:"),
                                html.P(id="job-modal-industry-text",
                                       className="text-muted mb-2")
                            ], width=6)
                        ]),
                        dbc.Row([
                            dbc.Col([
                                ...
                                html.P(id="job-modal-company-size-text",
                                       className="text-muted mb-2")
                            ], width=6),
                            dbc.Col([
                                html.Strong("Website:"),
                                html.A(id="job-modal-company-website",
                                       href="#", target="_blank",
                ...
                dbc.Col([
                    ...
                    html.Div([
                        html.Div([
                            ...
                            html.Span(id="job-modal-confidence-badge",
                                     className="ms-2")
                        ], className="mb-2"),
                        html.Div([
                            html.Strong("Validation Method:"),
                            html.Span(id="job-modal-validation-badge",
                                     className="ms-2")
                        ], className="mb-2"),
                        html.Div([
                            html.Strong("Semantic Score:"),
                            html.Span(id="job-modal-semantic-display",
                    ...
                    html.Div([
                        html.P("How relevant is this job to you?",
                    ...
                    html.Div([
                        html.Div([
                            ...
                            html.P(id="job-modal-current-status",
                                   className="text-muted mb-2")
                        ]),
    ...
    ], id="job-modal", size="lg", is_open=False)
