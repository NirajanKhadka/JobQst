...
def create_salary_range_filter():
    ...
    return dbc.Card(
        [
            dbc.CardHeader(
                [html.I(className="fas fa-dollar-sign me-2"), html.Strong("Salary Range")]
            ),
            dbc.CardBody(
                [
...
def create_location_type_filter():
    ...
    return dbc.Card(
        [
            dbc.CardHeader(
                [html.I(className="fas fa-map-marker-alt me-2"), html.Strong("Work Arrangement")]
            ),
            dbc.CardBody(
                [
                    dbc.Checklist(
                        ...
                        options=[
                            {
                                "label": [html.I(className="fas fa-home me-2"), "Remote"],
                                "value": "remote",
                            },
                            {
                                "label": [html.I(className="fas fa-laptop-house me-2"), "Hybrid"],
                                "value": "hybrid",
                            },
                            {
                                "label": [html.I(className="fas fa-building me-2"), "On-site"],
                                "value": "onsite",
                            },
                        ],
...
def create_experience_level_filter():
    ...
    return dbc.Card(
        [
            dbc.CardHeader(
                [html.I(className="fas fa-user-graduate me-2"), html.Strong("Experience Level")]
            ),
            dbc.CardBody(
                [
                    dcc.Dropdown(
...
def create_job_freshness_filter():
    ...
    return dbc.Card(
        [
            dbc.CardHeader(
                [html.I(className="fas fa-calendar-alt me-2"), html.Strong("Posted Date")]
            ),
            dbc.CardBody(
                [
                    dbc.RadioItems(
...
def create_company_size_filter():
    ...
    return dbc.Card(
        [
            dbc.CardHeader([html.I(className="fas fa-users me-2"), html.Strong("Company Size")]),
            dbc.CardBody(
                [
                    dbc.Checklist(
...
def create_application_status_filter():
    ...
    return dbc.Card(
        [
            dbc.CardHeader(
                [html.I(className="fas fa-tasks me-2"), html.Strong("Application Status")]
            ),
            dbc.CardBody(
                [
                    dbc.Checklist(
...
def create_quick_filters():
    ...
    return dbc.Card(
        [
            dbc.CardHeader([html.I(className="fas fa-bolt me-2"), html.Strong("Quick Filters")]),
            dbc.CardBody(
                [
                    dbc.ButtonGroup(
                        [
...
def create_search_box():
    ...
    return dbc.Card(
        [
            dbc.CardHeader([html.I(className="fas fa-search me-2"), html.Strong("Search Jobs")]),
            dbc.CardBody(
                [
                    dbc.InputGroup(
                        [
...
def create_filter_summary():
    ...
    return html.Div(
        [
            ...
            html.Small(id="filter-results-count", className="text-muted mt-2 d-block"),
        ],
        className="mb-3",
    )
