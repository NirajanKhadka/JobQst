...
def create_system_layout():
    ...
    return html.Div(
        [
            # Page header
            create_page_header("🖥️ System Monitor", "Monitor system health and performance"),
            ...
            dbc.Row(
                [
                    dbc.Col(
                        [
                            create_health_card(
                                "Database", "Healthy", "fas fa-database", "success", "db-health"
                            )
                        ],
                        width=3,
                    ),
                    dbc.Col(
                        [
                            create_health_card(
                                "API Server", "Running", "fas fa-server", "success", "api-health"
                            )
                        ],
                        width=3,
                    ),
                    dbc.Col(
                        [
                            create_health_card(
                                "Cache", "Active", "fas fa-memory", "warning", "cache-health"
                            )
                        ],
                        width=3,
                    ),
                    dbc.Col(
                        [
                            create_health_card(
                                "Scrapers", "Ready", "fas fa-spider", "info", "scraper-health"
                            )
                        ],
                        width=3,
                    ),
                                    ...
                                    dbc.CardBody(
                                        [
                                            html.Div(
                                                [
                                                    html.Label(
                                                        "CPU Usage", className="fw-semibold"
                                                    ),
                                                    dbc.Progress(
                                                        value=25, id="cpu-usage", className="mb-3"
                                                    ),
                                                    html.Label(
                                                        "Memory Usage", className="fw-semibold"
                                                    ),
                                                    dbc.Progress(
                                                        value=45,
                                                        id="memory-usage",
                                                    ...
                                                    html.Label(
                                                        "Disk Usage", className="fw-semibold"
                                                    ),
...
def create_service_status(service_name, is_running):
    ...
    return dbc.ListGroupItem(
        [
            dbc.Row(
                [
                    dbc.Col([html.Span(service_name, className="fw-semibold")], width=8),
                    dbc.Col(
                        [
                            dbc.Badge(
