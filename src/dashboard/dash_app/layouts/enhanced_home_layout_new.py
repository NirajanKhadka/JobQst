                                    ...
                                    html.Div(
                                        [
                                            html.H1(
                                                [
                                                    html.I(
                                                        className="fas fa-search me-3 text-primary"
                                                    ),
                                                    "JobLens",
                                                ],
                                    ...
                                    dbc.Row(
                                        [
                                            dbc.Col(
                                                [
                                                    html.I(
                                                        className="fas fa-briefcase fa-3x text-primary"
                                                    )
                                                ],
                                                width=3,
                                            ...
                                            dbc.Col(
                                                [
                                                    ...
                                                    html.P(
                                                        "Total Jobs", className="text-muted mb-0"
                                                    ),
                                                ],
                                                width=9,
                                            ),
                                    ...
                                    dbc.Row(
                                        [
                                            dbc.Col(
                                                [
                                                    html.I(
                                                        className="fas fa-paper-plane fa-3x text-success"
                                                    )
                                                ],
                                                width=3,
                                                className="d-flex align-items-center",
                                            ...
                                            dbc.Col(
                                                [
                                                    ...
                                                    html.P(
                                                        "Applications", className="text-muted mb-0"
                                                    ),
                                                ],
                                                width=9,
                                            ),
                                    ...
                                    dbc.Row(
                                        [
                                            dbc.Col(
                                                [
                                                    html.I(
                                                        className="fas fa-calendar-alt fa-3x text-warning"
                                                    )
                                                ],
                                                width=3,
                                                className="d-flex align-items-center",
                                            ...
                                            dbc.Col(
                                                [
                                                    ...
                                                    html.P(
                                                        "Interviews", className="text-muted mb-0"
                                                    ),
                                                ],
                                                width=9,
                                            ),
                                        ...
                                        [
                                            ...
                                            dbc.Col(
                                                [
                                                    ...
                                                    html.P(
                                                        "Success Rate", className="text-muted mb-0"
                                                    ),
                                                ],
                                                width=9,
                                            ),
...
def create_quick_actions():
    ...
    return dbc.Card(
        [
            dbc.CardHeader(
                [html.H5([html.I(className="fas fa-bolt me-2"), "Quick Actions"], className="mb-0")]
            ),
            dbc.CardBody(
                [
                    dbc.Row(
                        [
                            dbc.Col(
                                [
                                    dbc.Button(
                                        [html.I(className="fas fa-search me-2"), "Discover Jobs"],
                                        color="primary",
                                        size="lg",
                            ...
                            dbc.Col(
                                [
                                    dbc.Button(
                                        [html.I(className="fas fa-plus me-2"), "Add Application"],
                                        color="success",
                                        size="lg",
                                        className="w-100 mb-2",
                                        id="add-app-btn",
    ...
    return dbc.Card(
        [
            dbc.CardHeader(
                [
                    html.H5(
                        [html.I(className="fas fa-stream me-2"), "Application Pipeline"],
                        className="mb-0",
                    )
                ]
            ),
            dbc.CardBody(
                [
                    html.Div(
                        [
                            dbc.Progress(
                                value=20, color="info", label="Discovered", className="mb-2"
                            ),
                            dbc.Progress(
                                value=15, color="primary", label="Applied", className="mb-2"
                            ),
                            dbc.Progress(
                                value=10, color="warning", label="Interviewing", className="mb-2"
                            ),
                            dbc.Progress(value=5, color="success", label="Offers"),
                        ],
                        className="mb-3",
                    ),
                    dbc.Row(
                        [
                            dbc.Col([html.Small("🔍 Discovered: 0", className="text-muted")], md=3),
                            dbc.Col([html.Small("📤 Applied: 0", className="text-muted")], md=3),
                            dbc.Col(
                                [html.Small("🗣️ Interviewing: 0", className="text-muted")], md=3
                            ),
                            dbc.Col([html.Small("🎉 Offers: 0", className="text-muted")], md=3),
                        ]
                    ),
                ]
            ),
