...
def create_analytics_layout():
    ...
    return html.Div([
        ...
        dbc.Row([
            dbc.Col([
                create_kpi_card("Success Rate", "0%", "fas fa-percentage", "success", "success-rate-kpi")
            ], width=3),
            dbc.Col([
                create_kpi_card("Avg Match Score", "0%", "fas fa-bullseye", "info", "avg-match-kpi")
            ], width=3),
            dbc.Col([
                create_kpi_card("Total Companies", "0", "fas fa-building", "primary", "companies-kpi")
            ], width=3),
            dbc.Col([
                create_kpi_card("Active Days", "0", "fas fa-calendar", "warning", "active-days-kpi")
            ], width=3)
        ], className="mb-4"),
        ...
        dbc.Row([
            dbc.Col([
                dbc.Card([
                    ...
                    dbc.CardBody([
                        dcc.Graph(id="jobs-timeline-chart")
                    ])
                ])
            ], width=8),
            dbc.Col([
        ...
        dbc.Row([
            dbc.Col([
                dbc.Card([
                    ...
                    dbc.CardBody([
                        dcc.Graph(id="companies-bar-chart")
                    ])
                ])
            ], width=6),
            dbc.Col([
        ...
        dbc.Row([
            dbc.Col([
                dbc.Card([
                    ...
                    dbc.CardBody([
                        dcc.Graph(id="match-score-histogram")
                    ])
                ])
            ], width=12)
        ])
