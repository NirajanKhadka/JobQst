...
def create_processing_layout():
    ...
    return html.Div(
        [
            # Page header
            create_page_header("⚙️ Job Processing", "Manage job analysis and processing pipeline"),
            ...
            dbc.Row(
                [
                    dbc.Col(
                        [
                            create_status_card(
                                "Queue Status", "Ready", "fas fa-list", "success", "queue-status"
                            )
                        ],
                        width=3,
                    ),
                    ...
                    dbc.Col(
                        [
                            create_status_card(
                                "Completed", "0", "fas fa-check", "primary", "completed-count"
                            )
                        ],
                        width=3,
                    ),
                    dbc.Col(
                        [
                            create_status_card(
                                "Errors", "0", "fas fa-exclamation", "danger", "error-count"
                            )
                        ],
                        width=3,
                    ),
                            ...
                            dbc.Row(
                                [
                                    dbc.Col(
                                        [
                                            html.Label(
                                                "Processing Method", className="fw-semibold"
                                            ),
                                            dcc.Dropdown(
                                                id="processing-method",
                                                options=[
                                                    {
                                                        "label": "Two-Stage Pipeline (Recommended)",
                                                        "value": "two_stage",
                                                    },
                                    ...
                                    dbc.Col(
                                        [
                                            dbc.Checklist(
                                                ...
                                                options=[
                                                    {
                                                        "label": "Enable Smart Filtering",
                                                        "value": "smart_filtering",
                                                    },
                                                    {
                                                        "label": "Auto-Apply High Matches",
                                                        "value": "auto_apply",
                                                    },
                                                    {
