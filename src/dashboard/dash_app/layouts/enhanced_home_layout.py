    ...
    return html.Div([
        ...
        dbc.Card([
            dbc.CardBody([
                dbc.Row([
                    dbc.Col([
                        html.H3("🚀 Welcome to JobQst", className="text-primary mb-0"),
                        html.P("Your AI-powered job discovery platform", className="text-muted")
                    ], width=8),
                    dbc.Col([
                        dbc.Button(
                            "🎯 Start Job Search",
        ...
        dbc.Row([
            ...
            dbc.Col([
                create_stat_card("📅 Scheduled", "0", "scheduled-count", "info")
            ], width=3),
            dbc.Col([
                create_stat_card("🎯 Applied", "0", "applied-count", "warning")
            ], width=3)
        ], className="mb-4"),
        ...
        dbc.Row([
            ...
            dbc.Col([
                ...
                dbc.Card([
                    dbc.CardHeader([
                        dbc.Row([
                            dbc.Col([
                                html.H5("🎯 Latest Job Matches", className="mb-0")
                            ], width=8),
                            dbc.Col([
                                dbc.Button(
                                    "🔄 Refresh",
                    ...
                    dbc.CardBody([
                        html.Div(id="home-job-feed", children=[
                            create_placeholder_job_cards()
                        ])
                    ])
                ])
            ], width=8),
            ...
            dbc.Col([
                ...
                dbc.Card([
                    ...
                    dbc.CardBody([
                        html.Div(id="automation-status", children=[
                            create_automation_status_display()
                        ])
                    ])
                ], className="mb-4"),
                ...
                dbc.Card([
                    ...
                    dbc.CardBody([
                        ...
                        dcc.Dropdown(
                            ...
                            options=[
                                {'label': '📅 Daily at 9 AM', 'value': 'daily_9am'},
                                {'label': '📅 Twice Daily (9 AM, 6 PM)', 'value': 'twice_daily'},
                                {'label': '📅 Weekly Monday 9 AM', 'value': 'weekly_monday'},
                                {'label': '📅 Custom Schedule', 'value': 'custom'}
                            ],
                            placeholder="Choose schedule..."
                        ),
                        
                        html.Label("Search Keywords", className="fw-semibold mt-3"),
                        dbc.Input(
